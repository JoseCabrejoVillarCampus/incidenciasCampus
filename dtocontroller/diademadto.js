...
__decorate([
    ...
    Transform(({ value }) => { if (/^[0-9]+$/.test(value) || value == undefined)
        ...
        throw { status: 400, message: `El dato id_diadema incumple los parametros acordados` }; }, { toClassOnly: true }),
    __metadata("design:type", Number)
], diademaDTO.prototype, "id_diadema", void 0);
__decorate([
    ...
    Transform(({ value }) => { if (/^[a-z A-Z áéíóúÁÉÍÓÚñÑüÜ 0-9]+$/.test(value))
        ...
        throw { status: 400, message: `El dato marca_diadema incumple los parametros acordados` }; }, { toClassOnly: true }),
    __metadata("design:type", String)
], diademaDTO.prototype, "marca_diadema", void 0);
__decorate([
    ...
    Transform(({ value }) => { if (/^[a-z A-Z áéíóúÁÉÍÓÚñÑüÜ 0-9]+$/.test(value))
        ...
        throw { status: 400, message: `El dato color_diadema incumple los parametros acordados` }; }, { toClassOnly: true }),
    __metadata("design:type", String)
], diademaDTO.prototype, "color_diadema", void 0);
__decorate([
    ...
    Transform(({ value }) => { if (/^[0-9]+$/.test(value) || value == undefined)
        ...
        throw { status: 400, message: `El dato estado_diadema incumple los parametros acordados` }; }, { toClassOnly: true }),
    __metadata("design:type", Number)
], diademaDTO.prototype, "estado_diadema", void 0);
__decorate([
    Expose({ name: 'id' }),
    IsNumber(),
    Transform(({ value }) => { if (/^[0-9]+$/.test(value) || value == undefined)
    ...
    __metadata("design:type", Number)
], diademaDTO.prototype, "id", void 0);
